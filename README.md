...
Builder 1.6.0 adds optional gates — annotated render, request-scoped render
filters, server-side composition instantiation, bulk page creation, global
styles PATCH, design profiles, per-component contract reads and WordPress
